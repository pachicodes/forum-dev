// Categories grid component - Versão para sidebar
function renderCategoriesGrid() {
  ...
  const categoryItems = categories.map(category => `
    <div class="border-top color-border-muted py-3">
      <a href="#" class="d-flex flex-items-center color-fg-default text-decoration-none">
        <span class="d-inline-block mr-2 p-1 ${category.color} color-fg-on-emphasis rounded-2">${category.icon}</span>
        <span class="f4 flex-auto">${category.name}</span>
  ...
  return `
    <div class="Box mb-4">
      <div class="Box-header">
        <h2 class="Box-title">Categorias Populares</h2>
      </div>
      <div class="Box-body p-0">
        ${categoryItems}
      </div>
      <div class="Box-footer text-center">
        <a href="#" class="btn-outline-mktg btn-sm">Ver todas as categorias</a>
      </div>
    </div>
  `;
}
